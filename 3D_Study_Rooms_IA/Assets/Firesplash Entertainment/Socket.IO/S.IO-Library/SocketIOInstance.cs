...
namespace Firesplash.UnityAssets.SocketIO
{
    ...
    public class SocketIOInstance
    {
        ...
        {
            SocketIOManager.LogDebug("This project is using a version of Firesplash Entertainment Socket.IO v3/v4 integration which has been licenses solely for educational use. It is not perimtted to publicate any code in compiled or uncompiled form containing our asset code (in compiled or uncompiled form). It is further not permitted to remove this message form the code.");
